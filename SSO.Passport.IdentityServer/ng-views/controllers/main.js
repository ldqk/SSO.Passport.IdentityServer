myApp.controller('main', ["$timeout", "$state", "$scope", "$http", function ($timeout, $state, $scope, $http) {
	...
	Highcharts.setOptions({
		...
		colors: ['#058DC7', '#50B432', '#ED561B', '#DDDF00', '#24CBE5', '#64E572', '#FF9655', '#FFF263', '#6AF9C4', '#F44336',
			'#E91E63', '#9C27B0', '#673AB7', '#3F51B5', '#2196F3', '#03A9F4', '#00BCD4', '#009688', '#4CAF50', '#8BC34A',
			'#CDDC39', '#FFEB3B', '#FFC107', '#FF9800', '#FF5722', '#d95548', '#9E0E9E', '#6f7D8B', '#0aaaea', '#f7aa67',
			'#e1622f', '#fd7d36', ' #fe9778', '#ff9b6a', '#f3d64e', '#f1b8e4', '#d9b8f1', ' #f1ccb8', '#f1f1b8', '#b8f1ed',
			'#b8f1cc', '#CDDC39', '#e7dac9', '#FFC107', '#FF9800', '#fa7497', '#f9b747', '#dcff93', '#b7d28d', ' #f2debd',
			'#b7d28d']
	});
	this.sidebarToggle = {
		left: false,
	...
	$scope.read= function(id) {
		$http.post("/msg/read",{id}).then(function(res) {
